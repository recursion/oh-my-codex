...
export const LEADER_CONDUCTOR_ROLE_ROUTING_DEGRADE_BLOCK = [
  ...
  'Before Ralplan work run `omx ralplan preflight --json`; stop on `unsupported_documented_leader_proof`, while an attached-tmux `omx_team` result authorizes only validated sequential Team consensus.',
